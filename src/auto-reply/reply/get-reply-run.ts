...
import { buildLocalOrchestrationPrompt } from "../../agents/local-orchestration.js";
...
export async function runPreparedReply(
  ...
  const localOrchestrationPrompt = buildLocalOrchestrationPrompt({
    cfg,
    agentId,
    provider,
    model,
