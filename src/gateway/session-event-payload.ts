...
export function buildGatewaySessionEventFields(params: {
  ...
  return {
    ...
    localAssist: sessionRow.localAssist,
    effectiveLocalAssist: sessionRow.effectiveLocalAssist,
    localAssistDefault: sessionRow.localAssistDefault,
    localMoe: sessionRow.localMoe,
    effectiveLocalMoe: sessionRow.effectiveLocalMoe,
    localMoeDefault: sessionRow.localMoeDefault,
