...
export function createAgentEventHandler({
  ...
  const buildSessionEventSnapshot = (
    ...
    return {
      ...
      localAssist: row?.localAssist,
      effectiveLocalAssist: row?.effectiveLocalAssist,
      localAssistDefault: row?.localAssistDefault,
      localMoe: row?.localMoe,
      effectiveLocalMoe: row?.effectiveLocalMoe,
      localMoeDefault: row?.localMoeDefault,
