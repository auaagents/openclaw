          ...
          ? renderMeasured(
              ...
              () =>
                renderChat({
                  ...
                  localTtsSpeakingMessageId: state.localTtsSpeakingMessageId,
                  ...
                  onReadMessageGroup: (group) => state.readLocalMessageGroup(group),
                  isReadingMessageGroup: (groupKey) => state.isReadingLocalMessageGroup(groupKey),
